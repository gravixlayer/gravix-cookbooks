...
| [**Autonomous AML Investigation Agent**](aml-investigation-agent.ipynb) | Multi-agent compliance system with chain-of-thought reasoning, regulatory citation, vector search, and automated client communication for AML investigations. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/aml-investigation-agent.ipynb) |
| [**GravixLayer Sandbox – Python**](sandbox-python.ipynb) | Get started with GravixLayer Sandbox by executing Python code in isolated environments. Simple workflow to create a sandbox and run your first program. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/sandbox-python.ipynb) |
| [**GravixLayer Sandbox – JavaScript**](sandbox-js.ipynb) | Get started with GravixLayer Sandbox by executing JavaScript code in isolated environments. Learn to run Node.js programs securely. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/sandbox-js.ipynb) |
| [**Sandbox + AI LLM Integration**](sandbox-ai-usage.ipynb) | Connect GravixLayer Sandbox to LLM inference, save AI responses to files inside sandboxes, and download results to local environment. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/sandbox-ai-usage.ipynb) |
| [**Log Processor with AI Summarization**](logprocessor.ipynb) | Execute commands in a sandbox, process application logs, and use AI to generate human-readable summaries of error patterns and insights. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/logprocessor.ipynb) |
| [**Insurance Agent with Sandbox**](insurance_agent.ipynb) | Multi-agent insurance documentation assistant using sandbox execution for secure, isolated processing with vector storage and embedding models. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/insurance_agent.ipynb) |
| [**AI Data Analyst**](data-analyst.ipynb) | Intelligent data analysis workflow that generates, executes, and visualizes Python code automatically using LLMs and secure sandbox environments. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/gravix-cookbooks/blob/main/data-analyst.ipynb) |
