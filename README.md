...
| [**Simple RAG**](Simple%20RAG.ipynb) | Minimal retrieval-augmented generation example: ingest docs, index vectors, and run basic retrieval. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/Code-Recipes/blob/main/Simple%20RAG.ipynb) |
| [**Agentic RAG Cookbook**](Agentic%20RAG%20Cookbook.ipynb) | End-to-end Agentic RAG cookbook: ingest, index, retrieve, prompt, and orchestrate agents. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gravixlayer/Code-Recipes/blob/main/Agentic%20RAG%20Cookbook.ipynb) |
